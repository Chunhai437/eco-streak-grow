  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      toast({
        ...
        description: "Chào mừng bạn đến với Green Living.",
      });
      navigate('/');
    } catch (error) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-green-800">Green Living</h1>
          <p className="text-green-600 mt-2">Cùng nhau sống xanh, bảo vệ môi trường</p>
        </div>

        <Card className="glass-effect shadow-xl">
          <CardHeader>
            <CardTitle className="text-center text-green-800">Chào mừng!</CardTitle>
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login" className="space-y-4">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full gradient-green text-white" disabled={isLoading}>
