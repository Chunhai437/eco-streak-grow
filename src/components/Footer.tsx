      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            ...
            <span className="font-bold text-xl">Green Living</span>
          </div>

          {/* Contact Info */}
          <div className="flex flex-col items-center md:items-end mb-4 md:mb-0">
            <p className="text-gray-300 mb-2">Liên hệ với chúng tôi</p>
          ...
          <div className="flex items-center space-x-4">
            <p className="text-gray-300 mr-2">Theo dõi chúng tôi:</p>
            <a
